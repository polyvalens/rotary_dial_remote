...
/**
  ...
  */
#include <stdio.h>
//#include "..\..\..\..\..\..\packages\rp2040\hardware\rp2040\1.13.1\pico-sdk\src\common\pico_binary_info\include\pico\binary_info\code.h" // for picotool bi_decl stuff
...
void wizchip_reset()
{
    ...
    // cpv bi_decl(bi_1pin_with_name(PIN_RST, "W5x00 RESET"));
}
...
void wizchip_spi_initialize(void)
{
    ...
    // cpv bi_decl(bi_3pins_with_func(PIN_MISO, PIN_MOSI, PIN_SCK, GPIO_FUNC_SPI));
    ...
    // make the SPI pins available to picotool
    // cpv bi_decl(bi_1pin_with_name(PIN_CS, "W5x00 CHIP SELECT"));
